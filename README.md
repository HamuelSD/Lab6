...
* **The Test Code:** All of my Selenium test classes (including the CRUD tests for Students and Courses, plus the accessibility tests) are located in the `tests/src/test/java/com/baarsch_bytes/end2end/` directory. [Screenshots Folder](tests/screenshots/).
